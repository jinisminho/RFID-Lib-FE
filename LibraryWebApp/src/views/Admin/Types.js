    ...
    render() {
        ...
        let patron_type = this.props.patron ? (
            <div className="content mt-2">
                ...
                >
                    <TableHeaderColumn dataField="name" dataAlign="center" editable={{ validator: (value, row) => { return this.stringValidator(value, "name") } }} tdStyle={{ whiteSpace: 'normal', wordWrap: 'break-word' }} >Name</TableHeaderColumn>
                    <TableHeaderColumn dataField="maxBorrowNumber" editable={{ validator: (value, row) => { return this.intValidator(value, "maxBorrowNumber") } }} dataAlign="center" tdStyle={{ whiteSpace: 'normal', wordWrap: 'break-word' }}>Total Checkouts Allowed</TableHeaderColumn>
