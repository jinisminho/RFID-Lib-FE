...
namespace UHF
{
    ...
    {
        private const string DLLNAME = @"UHFReader86.dll";
        ...
        [DllImport(DLLNAME, CallingConvention = CallingConvention.StdCall)]
        public static extern int SetCustomFunction(ref byte ComAdr,
                                               byte SpecFunc,
                                              int frmComPortindex);

        [DllImport(DLLNAME, CallingConvention = CallingConvention.StdCall)]
        public static extern int GetCustomFunction(ref byte ComAdr,
                                               ref byte SpecFunc,
                                              int frmComPortindex);
