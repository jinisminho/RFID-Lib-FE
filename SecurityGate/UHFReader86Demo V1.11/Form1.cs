...
namespace UHFReader86Demo
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            cbPorts.DropDownStyle = ComboBoxStyle.DropDownList; foreach (string port in ports)
            {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else if (rb_mode2.Checked)
            {
                btMode = 1;
            }
            else if (rb_mode3.Checked)
            {
                btMode = 2;
            }
            else
            ...
            fCmdRet = RWDev.SetCustomFunction(ref fComAdr, btMode, frmcomportindex);
            if (fCmdRet == 0)
            {
        ...
        {
            byte btMode = 0;
            fCmdRet = RWDev.GetCustomFunction(ref fComAdr, ref btMode, frmcomportindex);
            if (fCmdRet == 0)
            {
                if (btMode == 0)
